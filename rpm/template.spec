...
Name:           ros-humble-fss-time-interfaces
Version:        0.1.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS fss_time_interfaces package

License:        BSD-3-Clause
URL:            https://index.ros.org/p/fss_time_interfaces/#humble
...
%description
Distributed simulation time interfaces for FastSwarmSim.
